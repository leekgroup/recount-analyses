...
biocLite(c('ballgown', 'BiocParallel', 'BiocStyle', 'coop', 'derfinder', 'devtools', 'dplyr', 'downloader', 'edgeR', 'ffpe', 'GenomicRanges', 'IHW', 'knitcitations', 'limma', 'magrittr', 'matrixStats', 'org.Hs.eg.db', 'qvalue', 'readr', 'rmarkdown', 'stringr', 'SummarizedExperiment', 'topGO'))
