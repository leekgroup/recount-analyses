...
###########################
## data from recount ######
load("/dcl01/leek/data/sra_to_upload3/SRP012682/rse_gene.Rdata")
recountPd = read.delim("/dcl01/leek/data/sra_to_upload3/SRP012682/SRP012682.tsv")
...
save(gtexCounts, gtexMap, gtexPd, 
     ...
     file = "/dcl01/leek/data/recount-website/GTEx_checks/GTEx_websiteAndRecount_EntrezMatched_17559_vs_8551.rda",
     compress=TRUE)
```
