...
Again, differential expression analysis is carried out using `limma` and `voom`; however, this time at the exon, rather than gene, level. Data are again visualized using a volcano plot to assess the strength [ $log_2(fold change)$ ] and statistical significance [ $-log_10(p-value)$ ] for each exon.
