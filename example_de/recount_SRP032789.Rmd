...
Here is an example of how to download and analyze a `RangedSummarizedExperiment` object with the gene counts with SRA study id [SRP032789](http://trace.ncbi.nlm.nih.gov/Traces/sra/?study=SRP032789).  Here we show how to use `limma` and `topGO`  to perform the differential expression and gene set enrichment analysis.
